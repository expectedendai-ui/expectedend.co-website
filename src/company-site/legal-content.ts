...
export const LEGAL_CONTENT = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Contact messages", paragraphs: ["When you submit the guided Contact form, Expected End receives the name, reply email, inquiry selections, message, and source information you provide. Source information is limited to the Expected End page and supported campaign parameters.", "Expected End uses this information to review the inquiry, respond, keep appropriate business records, prevent abuse, and protect its rights. Please do not submit passwords, financial account information, trade secrets, or other highly sensitive or confidential information unless Expected End has agreed in writing to receive it securely."] },
      ...
      { heading: "Your choices and requests", paragraphs: ["You may choose not to submit the Contact form or use it to ask about information you previously sent. Depending on applicable law, you may request access, correction, or deletion. Expected End may need to verify a request and may retain information when legally permitted or required."] },
