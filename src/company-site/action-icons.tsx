...
export function LinkedInIcon({ className }: ActionIconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      <path fill="#fff" d="M7.15 9.3h2.52V17H7.15V9.3ZM8.41 5.6a1.46 1.46 0 1 1 0 2.92 1.46 1.46 0 0 1 0-2.92ZM11.25 9.3h2.42v1.05h.04c.34-.64 1.16-1.32 2.4-1.32 2.57 0 3.04 1.69 3.04 3.89V17h-2.52v-3.62c0-.86-.02-1.98-1.2-1.98-1.2 0-1.39.94-1.39 1.92V17h-2.79V9.3Z" />
    </svg>
  );
}
